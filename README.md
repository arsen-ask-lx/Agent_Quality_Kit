...
Версия 1, один автор. Сам комплект держит **AQK-3**: тринадцать гейтов объявлено и прогоняется
конвейером, два реестра долга под храповиком. Пока комплектом пользуется один человек, AQK — красивое слово
