...
Версия 1, один автор. Сам комплект держит **AQK-3**: восемнадцать проверок объявлено и
...
1. **Чужой пользователь.** Единственное, чего нельзя сделать своими руками, и единственное, что
   проверит все остальные утверждения.
2. **Завести манифест в своём проекте.** Уровень трёх своих проектов измерен и равен «не
   заведён»: пока стандарт применён только к самому комплекту.
3. **Разбор ошибки — сценарий 4.3.** Человек сам догадывается, общая шишка или частная;
   программа могла бы спросить три вопроса и предложить запись каталога.
4. **Порядок «с нуля» — сценарий 4.1.** Он описан в методичках, но программа его не ведёт.
