...
- \`.aqk/skills/README.md\` — чужие скиллы: что посмотреть, что НЕ ставить и почему.
  Ставить не всё: решение твоё, и перед установкой читается живая версия по ссылке, а не наша
  строка — она снимок
