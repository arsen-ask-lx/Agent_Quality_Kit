...
**Предел настраивается** переменной `AQK_MAX_DEPTH`, по умолчанию пять уровней. Не целое больше
нуля (`abc`, `-3`, `0`) — код 2, «проверка не состоялась»: раньше такое значение молча давало зелёный.
