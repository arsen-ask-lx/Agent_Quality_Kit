...
case "$WIN" in
  ''|*[!0-9]*|0*) echo "AQK_DUP_LINES=«$WIN» — не целое больше нуля, проверка НЕ СОСТОЯЛАСЬ"
                 echo "  почини: задай AQK_DUP_LINES числом (строк в повторе, по умолчанию 8) или убери переменную."
                 exit 2 ;;
esac
