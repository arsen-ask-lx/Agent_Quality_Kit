...
| Если вы… | Читайте |
|---|---|
| ведёте проект как **владелец**, а не как программист | [Стратегия разработки приложений](../Стратегия_по_разработки_приложений.md) |
...
| [`../Стратегия_по_разработки_приложений.md`](../Стратегия_по_разработки_приложений.md) | документ владельца: бизнес-ТЗ → ограничения → сайзинг → тех-дизайн | OWNER DOCTRINE |
