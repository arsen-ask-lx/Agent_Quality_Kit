...
### Чего у них нет и что осталось бы нам
...
Своей записи пока нет — не назван настоящий отказ, а без него запись условная. Кандидат
записан здесь, чтобы к нему вернуться, когда отказ появится.
